...
class HttpTools {
    ...
    /**
     * 获取请求路径，都在requset的attributes属性中
     *
    ...
    static String getRequestPath(HttpServletRequest request) {
        ...
        return (obj == null) ? request.getRequestURI() : (String) obj;
    }
     ...
     * @return html
     */
    static String errorHtml(HttpServletRequest request) {
        ...
        final String home = StringUtils.isEmpty(request.getContextPath()) ? "/" : request.getContextPath();
        return "<!DOCTYPE html>\n" +
                "<html>\n" +
                "<head>\n" +
                ...
                "        <h1 style=\"color: red\">" + status.value() + "</h1>\n" +
                "        " + message + "\n" +
                "        <div><br /></div>\n" +
                "        <div id=\"showTime\" style=\"color: green; font-size: x-small\"></div>\n" +
                "    </label>\n" +
                "    <a href=\"" + home + "\" class=\"logo logo-img-1x\">返回首页</a>\n" +
                "</div>\n" +
                "<script>\n" +
                "    setInterval(\"fun()\", 1);\n" +
                "    function fun() {\n" +
                ...
                "        }\n" +
                "\n" +
                "        document.getElementById(\"showTime\").innerHTML = y + \"-\" + m + \"-\" + d + \"   \" + h + \":\" + minute + \":\" + s + \".\" + sss + \"  \" + ww;\n" +
                "    }\n" +
                "</script>\n" +
                "</body>\n" +
                "\n" +
